...
export const zh = {
  ...
  'message.turnProcess.deepDivingFor': '{activity}，用时{duration}',
  ...
  'chat.deepDiving.tool': '执行工具 · {name}',
  'chat.deepDiving.thinking': '思考中…',
  'chat.deepDiving.outputting': '输出中…',
  'chat.deepDiving.waiting': '等待模型响应…',
...
export const en = {
  ...
  'message.turnProcess.deepDivingFor': '{activity} for {duration}',
  ...
  'chat.deepDiving.tool': 'Running tool · {name}',
  'chat.deepDiving.thinking': 'Thinking…',
  'chat.deepDiving.outputting': 'Outputting…',
  'chat.deepDiving.waiting': 'Waiting for model…',
