...
/**
 * Phase-aware activity of one running Turn: which locale label describes what
 * that Turn is waiting on, and the Turn it belongs to so only that Turn's own
 * renderers adopt it.
 */
...
/** Activity of the newest running Turn, or null when no Turn is open. */
export type RunningTurnActivity = TurnActivity | null
...
export interface ChatNodeOwnerProps {
  ...
  /** Running activity of this Node's own Turn; absent for every other Turn. */
