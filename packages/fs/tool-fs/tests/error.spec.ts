 ...
 * failures, the stale-version and exact-copy remedies, code preservation, and
 * passthrough.
 */
...
describe('remediateFsError', () => {
  ...
  it('appends the exact-copy remedy to FS_EDIT_NOT_FOUND', () => {
    const remedied = remediateFsError(new FsError('old_string was not found in "x"', 'FS_EDIT_NOT_FOUND'), 'x') as FsError
